...
# A->Z: 0x41 -> 0x5A (65-90 in decimal)
# a->z: 0x61 -> 0x7A (97-122 in decimal)
# space is 32, or 0x20
def generate_match_list():
    l = [];
    # need to fix this when im less tired...
    for i in range(65, 91): 
        l.append(strxor(hex(i), hex(32)))
    for j in range(97, 123): 
        print(j)
    return l
# code
def main(): 
    match_list = generate_match_list()
    print
    print 'MATCH LIST:'
    print match_list
